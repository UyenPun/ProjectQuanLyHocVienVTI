...
const BasicInformation = (props) => {
    return <Card>
        ...
        <CardBody className="text-center">
            ...
            <div className="text-muted mb-2">duy.nguyenngoc1</div>
        ...
        <CardBody>
            ...
            <ul className="list-unstyled mb-0">
                ...
                <li className="mb-1">
                    <Home width={14} height={14} className="mr-1" /> Bank:{" "}
                    <span className="text-right text-primary" to="#">Viettin Bank</span>
                </li>
                <li className="mb-1">
                    <MapPin width={14} height={14} className="mr-1" /> Bank account number :{" "}
                    <span className="text-right text-primary" to="#">021652558</span>
                </li>
                <li className="mb-1">
                    <MapPin width={14} height={14} className="mr-1" /> tax address :{" "}
                    <span className="text-right text-primary" to="#">19 Lê Thanh Nghị</span>
                </li>
            </ul>
        </CardBody>
        ...
        <CardBody>
            ...
            <ul className="list-unstyled mb-0">
                ...
                <li className="mb-1">
                    <Mail width={14} height={14} className="mr-1" /> Total Mentee:{" "}
                    <span className="text-right text-primary" to="#">18</span>
                </li>
